...
description: |
  ...
  Include proactive triggers like "Proactively suggest when..." to combat
  undertriggering. Example: "Proactively suggest when the user reports errors,
  unexpected behavior, or is troubleshooting why something stopped working."]
author: Claude Code
version: 1.0.0
date: YYYY-MM-DD
allowed-tools:
  ...
  - Grep
  - Glob
  # Add other tools needed by this skill (e.g., Bash, WebSearch, AskUserQuestion)
---
...
<!--
Extraction Checklist (review before saving):
