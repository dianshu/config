...
| `~/.config/ghostty/config` | `~/repos/config/ghostty/config` | Full sync (cmux reads for fonts/themes) |
| `~/.config/cmux/settings.json` | `~/repos/config/cmux/settings.json` | Full sync |
