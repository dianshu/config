...
sync() {
    ...
    if [[ "$_zshrc_os" == "Darwin" ]]; then
        ...
        case "$id" in
            ...
            *) echo "Unsupported distro: $id $version"; return 1 ;;
        esac
    else
        echo "Unsupported OS: $_zshrc_os"; return 1
    fi
...
cc_remote() {
    ...
    tmux new-session -d -s cc_remote -c ~/repos "hapi hub --tunnel"
